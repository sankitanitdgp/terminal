...
namespace Microsoft::Console::VirtualTerminal
{
    ...
    private:
        ...
        DWORD _GetCursorKeysModifierState(const til::clump_view<size_t> parameters, const CsiActionCodes actionCode) noexcept;
        DWORD _GetGenericKeysModifierState(const til::clump_view<size_t> parameters) noexcept;
        DWORD _GetSGRMouseModifierState(const til::clump_view<size_t> parameters) noexcept;
        ...
        bool _GetGenericVkey(const til::clump_view<size_t> parameters,
                             short& vkey) const;
        ...
        bool _GenerateWin32Key(const til::clump_view<size_t> parameters, KeyEvent& key);
        ...
        bool _GetSGRXYPosition(const til::clump_view<size_t> parameters,
                               size_t& line,
                               size_t& column) const noexcept;
